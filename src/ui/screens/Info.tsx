    ...
    <>
      ...
      <ul>
        <li>
          ...
          יופיע לכולם. שם המתחרה נשמר גם עם החשבון, כדי שתתחרו תחת אותה קבוצה מכל מכשיר.
        </li>
        <li>
      ...
      <ul>
        <li>
          <b>בדפדפן שלכם:</b> שם המתחרה ב-localStorage והמודלים ב-IndexedDB. המחיקה שלהם
          בשליטתכם המלאה, גם דרך הגדרות הדפדפן.
        </li>
        <li>
          <b>עם החשבון:</b> עותק של שם המתחרה, במקום הפרטי שרק אתם קוראים ממנו, כדי שהוא
          יעבור איתכם בין מכשירים. מחיקת הנתונים מוחקת גם אותו.
        </li>
        <li>
